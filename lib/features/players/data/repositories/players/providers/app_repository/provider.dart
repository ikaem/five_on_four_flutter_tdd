...
import 'package:five_on_four_flutter_tdd/features/players/data/data_sources/players_remote/providers/provider.dart';
...
PlayersRepository playersAppRepository(PlayersAppRepositoryRef ref) {
  final PlayersRemoteDataSource playersRemoteDataSource =
      ref.read(playersRemoteFakeDataSourceProvider);
